...
resource "aws_instance" "instance2" {
  ...
  user_data = <<-EOF
              ...
              class Handler(BaseHTTPRequestHandler):
                  def do_GET(self):
                      ...
                      self.end_headers()
                      self.wfile.write(b'Hello from your EC2 instance! 2 ')
  ...
  provisioner "local-exec" {
    command = "echo 'private instance-2 IP: ${self.private_ip}' >> /home/mostafa/terralab/final-project/project/all-ips.txt"
  }
